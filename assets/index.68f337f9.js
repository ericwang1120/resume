...
`;class A extends m.Component{constructor(){super(...arguments),this.state={visible:!1},this.toggleVisibility=()=>{this.setState({visible:!this.state.visible})},this.disableVisibility=()=>{!0===this.state.visible&&this.setState({visible:!1})}}componentDidMount(){document.addEventListener("keydown",this.disableVisibility,!1)}render(){return m.createElement(W,null,m.createElement(S,{onToggle:this.toggleVisibility,onClick:this.disableVisibility}),m.createElement(b,{titleTemplate:"%s - Eric Wang's Personal Homepage",defaultTitle:"Eric Wang's Personal Homepage"},m.createElement("meta",{name:"description",content:"Eric Wang's Personal Homepage"})),m.createElement(h,{basename:"/resume"},m.createElement(k,(e=o({},this.state),l={onToggle:this.toggleVisibility},t(e,n(l)))),m.createElement(N,{onClick:this.disableVisibility},m.createElement(c.Pusher,null,m.createElement(L,null,m.createElement(f,null,m.createElement(y,{exact:!0,path:"/",component:P}),m.createElement(y,{path:"/resume",component:P}),m.createElement(y,{path:"/home",component:P}),m.createElement(y,{path:"",component:C})))))),m.createElement(z,{onClick:this.disableVisibility}));var e,l}}v`
  html,
  body {
    height: 100%;
    width: 100%;
...
`,x.render(m.createElement(A,null),document.getElementById("root"));
